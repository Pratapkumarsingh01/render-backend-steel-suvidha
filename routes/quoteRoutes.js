...
// --- FIXED: Used lowercase quoteController to match the import and added .bind ---
// POST /api/quotes/:id/payment - Submit payment proof (UTR/Transaction ID)
router.post('/:id/payment', quoteController.submitPayment.bind(quoteController));
...
// PATCH /api/quotes/:id/status - Update delivery status (for order fulfillment)
router.patch('/:id/status', quoteController.updateDeliveryStatus.bind(quoteController));
